...
cd ${GEM5_ROOT}
./build/ARM/gem5.opt \
    --outdir=${GEM5_OUTDIR}/water-spatial/${N_BIG}b${N_LITTLE}L/m5out-p${N_THREADS}-${KERN_GOV} \
    ...
    --bootscript=../gem5-bootscripts/benchmarks/water-spatial/n512-p${N_THREADS}.rcS \
