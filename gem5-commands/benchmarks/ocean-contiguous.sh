...
cd ${GEM5_ROOT}
./build/ARM/gem5.opt \
    --outdir=${GEM5_OUTDIR}/ocean/contiguous_partitions/${N_BIG}b${N_LITTLE}L/m5out-p${N_THREADS}-${KERN_GOV} \
    ...
    --bootscript=../gem5-bootscripts/benchmarks/ocean/contiguous_partitions/p${N_THREADS}-n258.rcS \
